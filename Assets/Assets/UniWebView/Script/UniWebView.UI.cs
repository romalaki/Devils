...
#pragma warning restore 618
    ...
    /// <summary>
    /// Gets the current shadow configuration applied to this web view.
    /// </summary>
    public UniWebViewShadow Shadow => shadow;
    ...
    /// <summary>
    /// Applies the provided shadow configuration to the web view container.
    /// </summary>
    /// <param name="value">The shadow definition.</param>
    public void SetShadow(UniWebViewShadow value) {
        shadow = value;
        UniWebViewInterface.SetShadow(
            listener.Name,
            value.Color.r,
            value.Color.g,
            value.Color.b,
    ...
    /// <summary>
    /// Convenience overload to set shadow properties.
    /// </summary>
    /// <param name="radius">Shadow blur radius.</param>
    /// <param name="opacity">Shadow opacity (0 - 1).</param>
    /// <param name="offset">Shadow offset.</param>
    /// <param name="color">Shadow color.</param>
    /// <param name="spread">Shadow spread distance.</param>
    public void SetShadow(float radius, float opacity, Vector2 offset, Color color, float spread = 0.0f) {
        SetShadow(new UniWebViewShadow(radius, opacity, offset.x, offset.y, color, spread));
    }
